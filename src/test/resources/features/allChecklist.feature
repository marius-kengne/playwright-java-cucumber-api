Feature: Tests API avancés avec Playwright + Java + Cucumber
  ...
  #Scenario: Génération d'un rapport de test
  #  Given je prépare un client HTTP Playwright
  #  When j'envoie une requête GET sur "http://localhost:5000/quotes"
  #  Then le code réponse doit être 200
  #  And un rapport de test doit être généré en JUnit XML
